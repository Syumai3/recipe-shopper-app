  ...
  createRecipe: {
    ...
    recipeIngredients: Array<{
      ...
      ingredient: {
        ...
        id: number;
        name: string;
        unit?: { __typename?: 'Unit'; id: number; unit: string } | null;
      };
    }>;
...
>;
export type GetRecipesSuspenseQueryHookResult = ReturnType<
  typeof useGetRecipesSuspenseQuery
>;
 ...
 * });
 */
export function useSearchIngredientsQuery(
  baseOptions: Apollo.QueryHookOptions<
    SearchIngredientsQuery,
    SearchIngredientsQueryVariables
  > &
    (
      | { variables: SearchIngredientsQueryVariables; skip?: boolean }
      | { skip: boolean }
    ),
) {
  const options = { ...defaultOptions, ...baseOptions };
  return Apollo.useQuery<
    SearchIngredientsQuery,
    SearchIngredientsQueryVariables
  >(SearchIngredientsDocument, options);
}
export function useSearchIngredientsLazyQuery(
  baseOptions?: Apollo.LazyQueryHookOptions<
    SearchIngredientsQuery,
    SearchIngredientsQueryVariables
  >,
...
export function useSearchIngredientsSuspenseQuery(
  baseOptions?:
    | Apollo.SkipToken
    | Apollo.SuspenseQueryHookOptions<
        SearchIngredientsQuery,
...
export type SearchIngredientsQueryHookResult = ReturnType<
  typeof useSearchIngredientsQuery
>;
export type SearchIngredientsLazyQueryHookResult = ReturnType<
  typeof useSearchIngredientsLazyQuery
>;
export type SearchIngredientsSuspenseQueryHookResult = ReturnType<
  typeof useSearchIngredientsSuspenseQuery
>;
export type SearchIngredientsQueryResult = Apollo.QueryResult<
  SearchIngredientsQuery,
  SearchIngredientsQueryVariables
>;
